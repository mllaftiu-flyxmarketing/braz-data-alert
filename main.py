...
from classes.projects_sessions import get_projects_sessions_problem_dates
...
def main(reason = "all"):   
     ...
     try:
          for project in projects:
               ...
               if reason == "projects_sessions" or reason == "all":
                    get_projects_sessions_problem_dates(project)
          sys.exit(0)
